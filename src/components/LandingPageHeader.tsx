import { MapPin, Moon, Sun, ArrowRight } from 'lucide-react';
...
export function LandingPageHeader({ isDark = false, onToggleTheme, onEnterApp }: LandingPageHeaderProps) {
  return (
    <header className="relative z-20 glass dark:glass-dark border-b border-white/20 dark:border-gray-600/20 shadow-2xl">
      <div className="max-w-[1800px] mx-auto px-8 sm:px-12 lg:px-16 py-6">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={onEnterApp}
              className="group relative px-6 py-3 bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-600 hover:to-cyan-600 text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 overflow-hidden"
            >
