            ...
            {sorted.map((c, idx) => {
              ...
              return (
                <div key={c.id} className="w-full flex-shrink-0 px-1">
                  <div className={`flex items-center gap-3 p-3 rounded-xl shadow-lg transition-all ${
                    isDark 
        ...
        <div className="flex gap-2">
          {sorted.map((c, idx) => {
            ...
            return (
              <div
                key={c.id}
                className={`flex-1 relative flex items-center gap-2 p-2.5 rounded-lg shadow-sm transition-all group ${
                  isDark
                    ? 'bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 hover:border-emerald-600'
                    : 'bg-gradient-to-br from-white to-gray-50 border border-gray-200 hover:border-emerald-300'
                } ${style.ring} ${style.hover}`}
              >
                {/* Badge rank */}
