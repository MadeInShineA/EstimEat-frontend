...
export const Legend = memo(function Legend({ isDark = false }: LegendProps) {
  ...
  const legendItems = [
    { color: 'rgb(30, 58, 138)', label: 'Very Low' },
    { color: 'rgb(59, 130, 246)', label: 'Low' },
    { color: 'rgb(6, 182, 212)', label: 'Medium Low' },
    { color: 'rgb(34, 197, 94)', label: 'Medium High' },
    { color: 'rgb(251, 191, 36)', label: 'High' },
    { color: 'rgb(249, 115, 22)', label: 'Very High' },
    { color: 'rgb(239, 68, 68)', label: 'Extreme' },
  ];
    ...
    <div className="w-full">
      ...
      <div className="lg:hidden">
        <button
          ...
          className={`flex items-center justify-between w-full py-2 px-3 rounded-lg transition-colors ${isDark ? 'bg-gray-700 hover:bg-gray-600' : 'bg-gray-50 hover:bg-gray-100'
            }`}
        >
